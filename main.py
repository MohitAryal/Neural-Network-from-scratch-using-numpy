...
X_train, y_train = generate_xor_data(n_samples=1000, noise=0.1)
...
# Train the model
, learned_b1, learned_w2, learned_b2 = train(X_train, y_train, lr=0.1, epoch=7000, input_size = 2, hidden_layer_size = 14, output_size=1)
